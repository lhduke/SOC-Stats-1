...
If we flip a fair coin four times, there are five possible outcomes (where "Heads" = "H" and "Tails" = "T"):
...
The total sample space reads as follows:\
Sample Space: {(T, T, T, T), (T, T, T, H), (T, T, H, H), (T, H, H, H), (H, H, H, H)}
